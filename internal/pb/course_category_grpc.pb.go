...
func (c *categoryServiceClient) GetCategoryById(ctx context.Context, in *Id, opts ...grpc.CallOption) (*Category, error) {
	out := new(Category)
...
func (UnimplementedCategoryServiceServer) GetCategoryById(context.Context, *Id) (*Category, error) {
...
func _CategoryService_GetCategoryById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).GetCategoryById(ctx, req.(*Id))
	}
	return interceptor(ctx, in, info, handler)
}
